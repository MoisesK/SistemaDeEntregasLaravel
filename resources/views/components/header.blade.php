<div class="jumbotron bg-warning p-3 my-3">
    ...
    <ul class=" nav nav-pills nav-justified navbar-dark bg-dark">
        <li class="nav-item"><a href="{{ route('deliveries.index') }}" class="nav-link fs-5 fst-italic">ENTREGAS</a></li>
        <li class="nav-item"><a href="{{ route('deliverymens.index') }}" class="nav-link fs-5 fst-italic ">ENTREGADORES</a></li>
    </ul>
